...
1.  **Quarterly Performance:** Total sales, broken down by category and quarter. (Visual: Bar Chart)
2.  **Product Extremes:** The top 5 and worst 5 performing products for each quarter. (Visual: Diverging Bar Chart)
3.  **Customer Demographics:** Which 3 customer age segments purchased the most in the last two quarters? (Visual: Grouped Bar Chart with Avg Spend Line)
